    ...
    <section id="intro-section">
      <div className="relative z-2 container flex h-full flex-col items-center gap-5 pt-8 max-lg:gap-20 lg:flex-row">
        ...
        <div id="intro-content" className="grow max-lg:pt-10">
          <h1 className="text-foreground text-center text-xl font-extrabold lg:text-start lg:text-3xl">
            {"Hello👋, I'm Hady Osman"}
            <br />a Frontend Developer.
          </h1>

          <p className="text-muted-foreground mt-6 max-w-[480px] text-center text-base font-medium text-balance lg:text-start lg:text-lg">
